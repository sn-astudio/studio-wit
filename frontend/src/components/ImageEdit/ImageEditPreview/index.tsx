...
import { Upload, Download, Clapperboard, ImagePlus, Minus, Wand2, Plus } from "lucide-react";
...
export function ImageEditPreview({
  ...
  return (
    <div
      className="relative flex flex-1 min-h-[30vh] items-center justify-center overflow-hidden rounded-2xl border-2 border-neutral-200 bg-white sm:min-h-0 dark:border-neutral-800/80 dark:bg-neutral-950/85"
      style={{
